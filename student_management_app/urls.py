...
urlpatterns = [
    ...
    path('manage_student1/', HodViews.manage_student1, name="manage_student1"),
    ...
    path('staff_feedback_pic_message/', HodViews.staff_feedback_pic_message, name="staff_feedback_pic_message"),
    path('staff_feedback_message_reply/', HodViews.staff_feedback_message_reply, name="staff_feedback_message_reply"),
    path('staff_feedback_pic_message_reply/', HodViews.staff_feedback_pic_message_reply, name="staff_feedback_pic_message_reply"),
    ...
    path('staff_feedback_pic/', StaffViews.staff_feedback_pic, name="staff_feedback_pic"),
    path('staff_feedback_pic_save/', StaffViews.staff_feedback_pic_save, name="staff_feedback_pic_save"),
    ...
    path('staff_bi_weekly_report/', StaffViews.staff_bi_weekly_report, name="staff_bi_weekly_report"),
    path('staff_good_deeds/', StaffViews.staff_good_deeds, name="staff_good_deeds"),
    ...
    path('student_survey/', StudentViews.student_survey, name="student_survey"),
]
